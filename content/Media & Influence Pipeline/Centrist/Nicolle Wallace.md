...
related: "[[Fox Corp - Rupert Murdoch]] · [[The Revolving Door (Media) — Government-to-Media Personnel Pipeline]] · [[Joe Scarborough]] · [[Anderson Cooper]] · [[Sean Hannity]] · [[Greg Gutfeld]] · [[Crooked Media]] · [[Patrick Bet-David]] · [[Mark Levin]] · [[The Platform Dependency Spectrum — Revenue Vulnerability Across Political Media]] · [[Tucker Carlson]] · [[Tim Pool]]"
---
...
- [FEC API: Nicolle Wallace individual contributions (0 results, $0.00)](https://api.open.fec.gov/v1/schedules/schedule_a/?contributor_name=WALLACE%2C+NICOLLE&api_key=DEMO_KEY&per_page=100&sort=-contribution_receipt_date) (Tier 1)
...
**Platform funder:** Comcast/NBCUniversal (MS NOW) ($3-5M/yr salary)
**Income dependency:** ~95% MS NOW salary; no independent platform; marriage to NYT journalist creates institutional bridge but not independent revenue
**Editorial red lines:** Cannot threaten pharma/corporate ad revenue; cannot criticize Democratic establishment too sharply (audience expectations); cannot reclaim Republican identity (brand depends on apostasy); marriage to NYT journalist creates implicit alignment with establishment liberal media consensus
