...
**Platform funder:** YouTube/Google (advertising infrastructure + algorithm-driven distribution). Previously BBTV/MCN ($620K extraction dispute). Teddy Fresh (Hila Klein's fashion brand) provides only non-platform revenue.
**Income dependency:** YouTube ad revenue (primary) + podcast sponsorships + Teddy Fresh merch + membership/SuperChat. Algorithm dependency is total: YouTube determines reach, monetization status, and content viability. Two demonetization events demonstrated the platform's editorial veto power.
**Editorial red lines:** Cannot sustain Israel/Palestine critique (October 7 audience capture pivot — engagement metrics reward pro-Israel positioning), cannot alienate sponsor ecosystem (brand-safe content required for ad revenue), cannot fundamentally challenge YouTube/Google (platform dependency). The capture is algorithmic rather than donor-driven: no single funder controls Klein, but Google's platform incentive structure produces the same editorial constraints as direct donor capture. FEC: $1,500 — negligible.
...
- [OpenSecrets: Ethan Klein donor lookup — FEC individual contribution records](https://www.opensecrets.org/donor-lookup/results?name=ethan+klein&cycle=&state=&zip=&employ=&cand=) (Tier 1)
- [FEC: Browse Individual Contributions — Ethan Klein, CA](https://www.fec.gov/data/receipts/individual-contributions/?contributor_name=ethan+klein&contributor_state=CA) (Tier 1)
...
- [Daily Dot: Was Ethan Klein's Lawsuit Against 3 Streamers a Trap For Hasan Piker?](https://www.dailydot.com/news/ethan-klein-copyright-lawsuit-hasan-piker/) (Tier 3)
