...
|---|---:|
| Tim Scott | $16,500 |
| Glenn Grothman | $6,500 |
| Tony Wied | $2,000 |
| Ron Johnson | $1,800 |
| Scott Fitzgerald | $500 |
...
|---|---:|
| Records linked | 10 |
| Leak sources | Bahamas Leaks (5) · Paradise Papers - Malta corporate registry (4) · Paradise Papers - Appleby (1) |
| Top jurisdictions | Bermuda (1) · Malta (1) |

**Example linked entities:**

| Name | Kind | Jurisdiction | Leak |
|---|---|---|---|
| INTERNATIONAL CORPORATE S | officer | — | Bahamas Leaks |
| STANDARD NOMINEES (BAHAMA | officer | — | Bahamas Leaks |
| WORLDCARE LIMITED | entity | Bermuda | Paradise Papers - Appleby |
| DEREK H L BUNTAIN | officer | — | Paradise Papers - Malta corporate registry |
| ANDREW MANDUCA | officer | — | Paradise Papers - Malta corporate registry |

*Full list: query Ask with* `subject: offshore_entities, linked_vault_entity: Bradley Foundation` *· Source: [ICIJ Offshore Leaks Database](https://offshoreleaks.icij.org/) · [ICIJ methodology](https://www.icij.org/about/).*
