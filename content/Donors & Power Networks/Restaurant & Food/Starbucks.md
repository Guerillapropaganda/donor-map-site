...
|---|---|---|---|
| HOWARD LAWRENCE | intermediary | — | Bahamas Leaks |

*Full list: query Ask with* `subject: offshore_entities, linked_vault_entity: Starbucks` *· Source: [ICIJ Offshore Leaks Database](https://offshoreleaks.icij.org/) · [ICIJ methodology](https://www.icij.org/about/).*
