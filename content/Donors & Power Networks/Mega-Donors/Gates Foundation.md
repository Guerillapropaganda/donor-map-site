...
**Grants received (2020):** $15.8M across 1 grantors (from other vault orgs' Schedule I records).

**Top 20 grantors:**

| Grantor | Total | Grants | Years |
|---|---:|---:|---|
| NEW VENTURE FUND | $15.8M | 1 | 2020 |
...
|---|---|---|---|
| BUTTERFIELD TRUST (BAHAMAS) LIMITED | intermediary | — | Bahamas Leaks |

*Full list: query Ask with* `subject: offshore_entities, linked_vault_entity: Gates Foundation` *· Source: [ICIJ Offshore Leaks Database](https://offshoreleaks.icij.org/) · [ICIJ methodology](https://www.icij.org/about/).*
