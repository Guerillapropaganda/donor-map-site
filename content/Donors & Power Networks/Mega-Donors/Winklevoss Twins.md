...
Crypto-friendly regulation (regulatory clarity without restrictive oversight), opposition to SEC enforcement against crypto exchanges (Gemini faced SEC charges over its Earn program), Bitcoin ETF approval (achieved 2024), favorable tax treatment for crypto assets, and state-level money transmitter licensing that doesn't impose burdensome compliance requirements.
