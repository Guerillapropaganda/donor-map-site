...
| Mark Kelly | $2,893 |
| Bob Casey | $2,250 |
| Jake Auchincloss | $500 |
| Catherine Cortez Masto | $487 |
...
|---|---|---|---|
| EQUUS CAPITAL AG (ZURICH CLIENT) | intermediary | — | Panama Papers |

*Full list: query Ask with* `subject: offshore_entities, linked_vault_entity: Moderna` *· Source: [ICIJ Offshore Leaks Database](https://offshoreleaks.icij.org/) · [ICIJ methodology](https://www.icij.org/about/).*
