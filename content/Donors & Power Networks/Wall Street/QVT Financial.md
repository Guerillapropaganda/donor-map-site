...
known-gaps:
  ...
  - Pipeline false positives: DOJ (264K generic results), NHTSA (hedge fund has no vehicles), SAM.gov (7670 contracts are wrong entity match). Flag for Code Claude pipeline fix.
