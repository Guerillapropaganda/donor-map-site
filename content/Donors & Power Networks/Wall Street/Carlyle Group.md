...
|---|---:|
| Records linked | 2 |
| Leak sources | Panama Papers (2) |

**Example linked entities:**

| Name | Kind | Jurisdiction | Leak |
|---|---|---|---|
| SMP PARTNERS LTD | intermediary | — | Panama Papers |
| THE BEARER | officer | — | Panama Papers |

*Full list: query Ask with* `subject: offshore_entities, linked_vault_entity: Carlyle Group` *· Source: [ICIJ Offshore Leaks Database](https://offshoreleaks.icij.org/) · [ICIJ methodology](https://www.icij.org/about/).*
