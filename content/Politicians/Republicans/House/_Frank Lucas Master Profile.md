...
| Item | Effect |
|------|--------|
| Commodity Price Supports | Established minimum price floors for corn, wheat, soybeans, cotton |
| Direct Payments | Created direct government payments to landowners based on historical acreage |
| Lucas's Benefit | His own ranch became eligible for these payments |
| Magnitude | Created $150B+ per-decade subsidy stream |
...
- [Source: DOJ Press Releases](https://www.justice.gov/news?query=%22Frank%20Lucas%22&sort=date) (Tier 1)
<!-- auto:doj-press end -->
