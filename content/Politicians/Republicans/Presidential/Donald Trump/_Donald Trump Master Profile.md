...
Generated by `scripts/fec-mega-donor-trace.cjs` from FEC pas2 + indiv bulk data. Tier 1: super-PACs spending IE-support for Trump. Tier 2: individuals funding those super-PACs.
...
[Source: FEC Form 3X pas2 + indiv bulk filings, cycle 2024 (Tier 1). Extracted via `scripts/fec-mega-donor-trace.cjs` per ADR-0013]
