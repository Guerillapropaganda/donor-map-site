---
title: "_Amy Coney Barrett Master Profile"
type: politician
...
### People of Praise, the Federalist Society, and the Parallel Pipelines:
- [[People of Praise and the Federalist Society as Parallel Selection Pipelines]] — People of Praise since college. Women called "handmaids" (renamed 2018). Community submission of major life decisions. Federalist Society membership since law school. Notre Dame → Scalia clerked → 7th Circuit → SCOTUS. Both institutions select, cultivate, and advance members through parallel hierarchies.

### The Supermajority Rulings and the Donor-Class Returns:
- [[The Supermajority Rulings and the Donor-Class Returns]] — Dobbs: overturned Roe (Barrett concurrence). Bruen: expanded gun rights. Students for Fair Admissions: ended affirmative action. West Virginia v. EPA: gutted regulatory authority. 303 Creative: religious exemption from anti-discrimination. Every ruling serves the donor coalition that funded the supermajority's construction.
...
#### Leonard Leo / Dark Money Confirmation (The Capstone)

| Date | Donor | Amount | Given | Policy Outcome |
|------|-------|--------|-------|----------------|
| 2020-10 | [[Leonard Leo]] + JCN — $22M+ total; Rule of Law Trust conduit received $21.5M in single year and routed to JCN; Leo architect of all 3 Trump picks | $22M+ dark money | 2020-09 (JCN campaign) | Barrett confirmed 52-48 in 30 days — fastest in modern history; McConnell reversed Garland precedent; 31 Republican senators broke prior positions; 8 days before election |
| 2016-02 | McConnell institutional hardball — blocked Garland 293 days to hold seat open; Barrett's path begins here | $0 cost, infinite leverage | 2016 | Scalia's seat held for Republican president; the $22M confirmation in 2020 only possible because of the 2016 blockade |

#### Religious Right / Donor Coalition

| Date | Donor | Amount | Given | Policy Outcome |
|------|-------|--------|-------|----------------|
| 2022-06 | Religious right donor coalition (Leo's 30-year project, People of Praise alignment) | Part of $22M investment | 2020-09 | Dobbs v. Jackson: Barrett concurrence endorses overturning Roe; emphasizes safe haven laws — the ruling Leo's network spent 50 years positioning for |
| 2023-06 | Religious right donor network (Leo infrastructure) | Part of $22M investment | 2020-09 | 303 Creative v. Elenis: Barrett joins majority creating religious exemption from anti-discrimination law for creative businesses |

#### Deregulatory / Fossil Fuel Outcomes

| Date | Donor | Amount | Given | Policy Outcome |
|------|-------|--------|-------|----------------|
| 2022-06 | Fossil fuel donors who funded $22M JCN campaign | Part of $22M investment | 2020-09 | West Virginia v. EPA: Barrett joins majority gutting EPA climate authority under "major questions doctrine" — 20-month return on investment |
| 2024-06 | All corporate sectors facing federal regulation | Part of $22M investment | 2020-09 | Loper Bright v. Raimondo: Barrett joins majority overruling [[Chevron]] deference — reshaping regulatory authority across every sector |

#### Conservative Legal Infrastructure / Gun Rights

| Date | Donor | Amount | Given | Policy Outcome |
|------|-------|--------|-------|----------------|
| 2022-06 | NRA and firearms industry donors (part of broader conservative donor coalition) | Part of $22M investment | 2020-09 | New York State Rifle v. Bruen: Barrett joins Thomas majority expanding gun rights under "text, history, and tradition" test |
| 2023-06 | Conservative legal infrastructure (FedSoc, Leo network) | Part of multi-decade Leo pipeline | 2020-09 | Students for Fair Admissions v. Harvard/UNC: Barrett joins 6-3 majority ending affirmative action |
| 2024-06 | Trump political network | Part of broader conservative donor infrastructure | 2020-09 | Trump v. United States: Barrett joins majority on presidential immunity; writes concurrence arguing majority goes further than necessary |

> [!money] The Damning Sequences
> **⚠️ 2-year flag:** $22M JCN dark money confirms Barrett (October 2020) → Dobbs overturns Roe (June 2022). The 20-month sequence is the clearest example of what the $22M purchased: Leo's network spent three decades constructing a 6-3 supermajority specifically to produce this outcome. Barrett was the capstone.
>
> **⚠️ 2-year flag:** $22M confirmation (October 2020) → West Virginia v. EPA guts climate authority (June 2022). The fossil fuel donors who funded JCN received a ruling gutting the EPA's most powerful climate tool within 20 months of Barrett's confirmation.
>
> **The McConnell → Leo → $22M pipeline:** Garland blocked (February 2016) → seat held 4 years → Trump wins → Leo selects Barrett → JCN spends $22M → Barrett confirmed in 30 days → every major 6-3 ruling delivers for the donor class. The sequence spans 4 years but represents a single coordinated investment in the Court's political economy.
...
**The Two-Audience Problem:** Before confirmation, Barrett performed the "blank slate" — declining substantive answers to signal that her record wouldn't reveal the guaranteed outcomes. After confirmation, her rulings have validated every prediction the donor class made when they spent $22 million. The performance of judicial independence hides the fact that Leo's network selected her specifically because her philosophy was already known.

**The Judicial Selection Pipeline:** People of Praise's internal governance — where women submit major life decisions to community leadership — mirrors the Federalist Society pipeline's governance structure. Barrett was selected, confirmed, and continues to be guided by networks where major decisions are made before her rather than by her. The Court has become an institution where independence is the illusion.
