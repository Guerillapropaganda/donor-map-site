---
title: "The Defense Budget Pipeline - Record Peacetime Spending and Contractor Profits"
type: sub-note
...
### [[Lockheed Martin|Lockheed Martin]] (largest U.S. defense contractor):
| Date | Event | Amount | Source |
|------|-------|--------|--------|
...
### [[Boeing|Boeing]] (defense division):
| Date | Event | Amount | Source |
|------|-------|--------|--------|
...
The military aid is direct revenue to U.S. defense contractors. Money flows from Congress → Defense Department → Lockheed Martin, Raytheon, Northrop, [[Boeing|Boeing]], etc. for weapons manufacturing and replacement.
...
- [OpenSecrets: Defense sector campaign spending 2022](https://www.opensecrets.org/industries/defense.php) (Tier 1)
- [ProPublica Congress: House defense budget voting records](https://projects.propublica.org/represent/committees/H.AS) (Tier 1)
...
- [Northrop Grumman annual reports, 2020–2023](https://www.northropgrumman.com/investors/) (Tier 1)
