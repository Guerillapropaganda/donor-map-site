...
Generated by `scripts/fec-mega-donor-trace.cjs` per ADR-0013 from FEC pas2 + indiv bulk (cycles 2020-2026). The trace confirms a structurally different money pattern: **Pelosi is not a mega-donor recipient, she is the mega-donor gatekeeper.**
...
[Source: FEC pas2 + indiv bulk, 2020-2026 cycles (Tier 1). Extracted via `scripts/fec-mega-donor-trace.cjs` per ADR-0013]
