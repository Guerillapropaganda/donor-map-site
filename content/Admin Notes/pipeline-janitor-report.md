...
Generated: 2026-04-11T03:32:15.380Z
Mode: DRY RUN (report only)

## Summary

- Profiles scanned: 1753
- Profiles at ready/verified audited: 380
- Profiles with issues: **256**
- Total issues: 295
...
- **Issues (2):**
  ...
  - `never-enriched` — no last-enriched date set → **run pipelines**
...
- **Path:** `Donors & Power Networks/Tech & Crypto/Fairshake PAC.md`
- **Current readiness:** `ready`
- **Type:** `pac`
- **Issues (2):**
  - `missing-block` — no fec pipeline data (no key, no block) → **run fec pipeline**
...
- **Path:** `Donors & Power Networks/Agriculture/California Farm Bureau Federation.md`
- **Current readiness:** `ready`
- **Type:** `donor`
- **Issues (1):**
  - `missing-block` — no fec pipeline data (no key, no block) → **run fec pipeline**
...
- **Path:** `Donors & Power Networks/Agriculture/National Cattlemen's Beef Association.md`
- **Current readiness:** `ready`
- **Type:** `donor`
- **Issues (1):**
  - `missing-block` — no fec pipeline data (no key, no block) → **run fec pipeline**
...
- **Path:** `Donors & Power Networks/Healthcare/Anthem - Elevance Health.md`
- **Current readiness:** `ready`
- **Type:** `donor`
- **Issues (1):**
  - `missing-block` — no fec pipeline data (no key, no block) → **run fec pipeline**
...
- **Path:** `Donors & Power Networks/Israel Lobby/JPAC - Jewish Public Affairs Committee of California.md`
- **Current readiness:** `ready`
- **Type:** `donor`
- **Issues (1):**
  - `missing-block` — no fec pipeline data (no key, no block) → **run fec pipeline**
...
- **Path:** `Donors & Power Networks/Mega-Donors/Jeffrey Katzenberg.md`
- **Current readiness:** `ready`
- **Type:** `donor`
- **Issues (1):**
  - `never-enriched` — no last-enriched date set → **run pipelines**
