---
title: "Class Tag Priority Queue"
type: admin-note
note-type: data
status: open
...
**Total unapproved with heuristic proposals:** 0
**🔴 Policy blockers (Rule 11):** 0 — block at least one policy page from publication
**🟡 Story blockers:** 0 — block at least one published story from verified promotion
**⚪ Widely linked (10+):** 0 — cited by many profiles, high leverage
**Orphans (0 citations):** 0 — low priority, can defer indefinitely
...
Keyboard shortcuts in Ops `/class-tags`: **A** approve, **R** reject, **E** edit before approving.
