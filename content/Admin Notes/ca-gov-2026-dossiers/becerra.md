---
title: "CA Gov 2026 Dossier — Xavier Becerra"
type: admin-note
tags: ["ca-gov-2026", "dossier", "becerra", "perplexity-verified"]
candidate: "Xavier Becerra"
archetype: "Institutional Democrat / former Cabinet"
tier: deep
fppc-committee-id: "1480025"
created: 2026-05-01
...
# CA Gov 2026 Dossier — Xavier Becerra

**Archetype:** Institutional Democrat / former Cabinet
**Profile:** [_Xavier Becerra Master Profile.md](../../content/Politicians/Races/CA Governor 2026/Xavier Becerra/_Xavier Becerra Master Profile.md)
**FPPC committee:** `1480025` · BECERRA FOR GOVERNOR 2026

## State-level money (Cal-Access)

**2026 cycle:** raised $5.75M from 5,061 donors (avg $1K/donor) · spent $0
**Lifetime state-level:** raised $25.53M from 7,738 donors across cycles 2018, 2020, 2022, 2026
**Committees referenced:** 4 FPPC IDs (1394091, 1414167, 1454809, 1480025)

### Top 15 donors — 2026 cycle

| Rank | Donor | $ | # contributions | Note |
|---:|---|---:|---:|---|
| 1 | California State Council of Laborers PAC | $55K | 1 | Cal-Access RCPT_CD: 2 receipt(s) totaling $54700.00 from "California State Counc… |
| 2 | Joseph Molina | $50K | 1 | Cal-Access RCPT_CD: 5 receipt(s) totaling $49700.00 from "Joseph Molina" to file… |
| 3 | Southern California District Council of Laborers PAC Small Contributor Committee | $47K | 1 | Cal-Access RCPT_CD: 3 receipt(s) totaling $47000.00 from "Southern California Di… |
| 4 | Tigran Martinian | $46K | 1 | Cal-Access RCPT_CD: 5 receipt(s) totaling $45600.00 from "Tigran Martinian" to f… |
| 5 | Pechanga Band of Luiseno Indians | $45K | 1 | Cal-Access RCPT_CD: 3 receipt(s) totaling $44600.00 from "Pechanga Band of Luise… |
| 6 | Alexandra Seros | $42K | 1 | Cal-Access RCPT_CD: 4 receipt(s) totaling $42200.00 from "Alexandra Seros" to fi… |
| 7 | Jules Buenabenta | $42K | 1 | Cal-Access RCPT_CD: 2 receipt(s) totaling $41900.00 from "Jules Buenabenta" to f… |
| 8 | Agua Caliente Band of Cahuilla Indians | $42K | 1 | Cal-Access RCPT_CD: 3 receipt(s) totaling $41900.00 from "Agua Caliente Band of … |
| 9 | Raul Ayala | $40K | 1 | Cal-Access RCPT_CD: 7 receipt(s) totaling $39950.00 from "Raul Ayala" to filer 1… |
| 10 | Altamed Health Network Inc. | $39K | 1 | Cal-Access RCPT_CD: 1 receipt(s) totaling $39200.00 from "Altamed Health Network… |
| 11 | Cindy Horn | $39K | 1 | Cal-Access RCPT_CD: 1 receipt(s) totaling $39200.00 from "Cindy Horn" to filer 1… |
| 12 | LCCC PAC | $39K | 1 | Cal-Access RCPT_CD: 1 receipt(s) totaling $39200.00 from "LCCC PAC" to filer 148… |
| 13 | Leonard Schaeffer | $39K | 1 | Cal-Access RCPT_CD: 1 receipt(s) totaling $39200.00 from "Leonard Schaeffer" to … |
| 14 | Morgan Chu | $39K | 1 | Cal-Access RCPT_CD: 1 receipt(s) totaling $39200.00 from "Morgan Chu" to filer 1… |
| 15 | Border Health Federal PAC | $39K | 1 | Cal-Access RCPT_CD: 1 receipt(s) totaling $39200.00 from "Border Health Federal … |

### Top 10 donors — lifetime state-level

| Rank | Donor | $ | # contributions |
|---:|---|---:|---:|
| 1 | Becerra for Attorney General 2018 | $1.89M | 2 |
| 2 | Tigran Martinian | $105K | 4 |
| 3 | Joseph Molina | $102K | 4 |
| 4 | California State Pipe Trades Council PAC | $101K | 4 |
| 5 | California State Association of Electrical Workers | $101K | 4 |
| 6 | Laborers Pacific Southwest Regional Organizing Coalition PAC | $98K | 2 |
| 7 | Peter Chernin | $94K | 4 |
| 8 | California State Council of Laborers - SCC | $89K | 3 |
| 9 | Faculty For Our University's Future, A Committee Sponsored By The California Faculty Association | $89K | 3 |
| 10 | Eric Early | $86K | 1 |

## Federal-level money (FEC)

**FEC IDs:** H2CA30143, C00264101
**Federal raised:** $0 (0 donors)
**Federal outgoing:** $2.21M (30 recipients)
**Cycles active:** 2004, 2006, 2010, 2012, 2014, 2016, 2018, 2022
**Sources:** fec-oppexp

### Top 10 federal-level recipients (where their money/influence flowed)

| Recipient | $ | # contributions |
|---|---:|---:|
| AUSTIN SCOTT FOR CONGRESS INC | $681K | 1 |
| OSSEN CARDENAS MEDIA | $260K | 1 |
| ARUM GROUP, LLC | $250K | 1 |
| ATTEBERRY, KRISTA | $181K | 1 |
| ANNE LEWIS STRATEGIES, LLC | $111K | 1 |
| CAPITAL STRATEGIES | $95K | 1 |
| LA QUINTA RESORT | $88K | 1 |
| GOODWIN SIMON STRATEGIC RESEARCH | $69K | 1 |
| Democratic Governors Association | $50K | 2 |
| CROSHAW PRINTING | $50K | 1 |

## Vault state

- **content-readiness:** draft
- **central-thesis:** Xavier Becerra is the institutional Democratic Party candidate — his entire career has been built within Democratic power structures (Congress for 24 years, AG appointed by a Democratic governor, Cabi…
- **last-updated:** 2026-04-09
- **1 sub-pages:**
  - `The HHS Record and the Healthcare Industry Question.md`

## Editorial angle

Becerra raised **$5.7M from 5,061 donors in the 2026 cycle** — average $1,135/donor — the second-lowest 2026 haul among the major Democratic candidates. His lifetime state-level total of $25.5M across 4 cycles is dwarfed by his FEC-side career: 8 federal cycles (2004-2022) of House campaign + leadership PAC giving, with $2.2M outgoing to other federal candidates and committees. The shape of his money tells a structural story: he is a 24-year creature of institutional Democratic infrastructure. Where he's now seeking funds for Governor — labor, healthcare, party-aligned PACs — overlaps almost completely with the regulated industries he oversaw at HHS (2021-2025).
...
## Phase 5g: Independent verification round (2026-05-02)

Ten Becerra donors put through primary-source verification (Cal-Access RCPT_CD direct query, joined to FILER_FILINGS_CD and CVR_CAMPAIGN_DISCLOSURE_CD on filer 1480025), then cross-referenced against HHS-OIG Corporate Integrity Agreement records, DOJ press releases, federal court dockets, HRSA grant data, IRS 990s, and select Tier 2 sources. Source: `Becerra_Donor_Verification_Report.md` (May 2026, 10/10 confirmed).

### Confirmed donor table (verified amounts and dates)

| # | Donor | Amount | Date | Filing | Materiality of Cal-Access discrepancy | Policy hook |
|---|-------|-------:|------|--------|---------------------------------------|-------------|
| 1 | Prime Healthcare Services, Inc. (Ontario CA) | $20,000 | 9/26/2025 | 3114278 line 1025 | None on identity | **HHS-OIG Corporate Integrity Agreement #2 active during Becerra's entire HHS tenure** |
| 2 | Raul Ayala (Fresno) | $33,900 | 6/17/2025 | 3071361 | **HIGH**: filed as "Manager" at Adventist Health; reality is senior physician executive (Ambulatory Medical Officer / DIO / multiple CMO titles / President-Elect CA Academy of Family Physicians) | Rural FQHC reimbursements; HHS / CMS oversight |
| 3 | Kelly Ayala (Fresno) | $16,100 | 6/17/2025 | 3071361 | Low: filed as generic "Physician"; reality is OB/GYN at Kaiser Permanente Fresno; same-date same-city pattern with Raul indicates household pair (combined $50,000) | Medicare Advantage / Medi-Cal managed care |
| 4 | AltaMed Health Network Inc. (Montebello) | $39,200 | 7/1/2025 | 3071361 | None on identity; city is Montebello (not LA) | **Largest FQHC in California**; HRSA Section 330 grants directly under HHS during Becerra's tenure |
| 5 | Morgan Chu (Los Angeles) | $39,200 | 6/19/2025 | 3071361 | Medium: filed as "Attorney"; reality is Partner since 1982 and Chair of Litigation Practice, Irell & Manella | Pharma / biotech IP litigation (lead on Juno/Sloan Kettering vs Kite Pharma $1.2B CAR-T case); IRA-opposition work [UNVERIFIED] |
| 6 | Cindy Horn (Los Angeles) | $39,200 | 5/27/2025 | 3071361 | None: this is Cynthia Harrell Horn, wife of Alan F. Horn (Disney studios chair 2012–2021); "Homemaker" is standard self-designation | Environmental / NRDC philanthropy (NRDC Chair 2018–2020); no direct HHS hook |
| 7 | Alexandra Seros (Pacific Palisades) | $39,200 | 4/8/2025 | 3071361 | None: Hollywood screenwriter (*Point of No Return*, *The Specialist*); married to Walter Ulloa (Entravision CEO) | No direct HHS hook; identity / community giving |
| 8 | Glen Dake (Los Angeles) | $10,000 | 4/3/2025 | 3071361 | Low imprecision: filed as "Architect"; reality is **landscape** architect (FASLA), founder of Dake Luna Consultants, former MWD board member | Public-sector LA infrastructure; no HHS hook |
| 9 | Patrick McNicholas (Los Angeles) | $25,000 | 6/11/2025 | 3071361 | Low: filed as "Self Employed / Attorney"; reality is Partner at McNicholas & McNicholas LLP | Plaintiffs' bar / state regulatory access; firm gave **$944,124** total across CA Democrats 2025–26, including identical $25K to Porter |
| 10 | Alonzo Cantu (McAllen TX) | $39,200 | 6/12/2025 | 3071361 | **HIGH**: filed as "Cantu Construction / Developer"; the omitted titles are the operative ones (Chairman of Lone Star National Bank; **co-founder of DHR Health**, one of the largest physician-owned hospital systems in the US) | **Stark Law / ACA §6001 physician-self-referral rules** governed by CMS during Becerra's tenure |

All 10 confirmed in primary Cal-Access records. No donor identity was incorrect. The two material discrepancies are Donors 2 (Raul Ayala title) and 10 (Cantu title).

### Strongest finding: Prime Healthcare HHS-OIG CIA #2

This is the cleanest direct conflict-of-interest receipt on the donor list, and it was not visible in the Phase 5b top-15 because the contribution amount ($20,000) sits below the max donor threshold.

- **$37.5M False Claims Act settlement, 2021-07-19.** Prime Healthcare, Dr. Prem Reddy (Chairman/President/CEO), and cardiologist Dr. Siva Arunasalam jointly resolved Anti-Kickback Statute and Stark Law allegations. Prime paid $33.725M; Reddy paid **$1.775M personally**; Arunasalam paid $2M. ([DOJ press release](https://www.justice.gov/archives/opa/pr/prime-healthcare-services-and-two-doctors-agree-pay-375-million-settle-allegations-kickbacks))
- **HHS-OIG Corporate Integrity Agreement #2.** Joint Prime/Reddy CIA executed June 2021, **estimated completion June 2026**. Required Prime to maintain a compliance program and engage an Independent Review Organization to audit physician-affiliate compensation. ([HHS-OIG CIA record](https://oig.hhs.gov/compliance/corporate-integrity-agreements/browse-cias/prime-healthcare-services-inc/))
- **The CIA was operative for Becerra's entire HHS tenure** (March 19, 2021 to January 20, 2025). It approaches its estimated completion date concurrent with the 2026 election cycle.
- **Prior matter (CIA #1):** Prime previously paid $65M to settle FCA claims of Medicare upcoding and unnecessary admissions across 14 California hospitals (2018, ~2018–2023 CIA). Reddy paid $3.25M personally; whistleblower received $17.225M.
- **Reddy donation pattern:** historically Republican; shifted heavily Democratic from 2021 forward, including $41,300 to DNC Services Corp on 2023-12-07 and approximately $123,000 to Democratic state parties on a single day 2024-06-14.

Editorial framing the data supports: a $20,000 contribution from Prime Healthcare (whose CIA was overseen by HHS-OIG during Becerra's entire tenure) to Becerra's gubernatorial campaign warrants the strongest scrutiny on this list. HHS-OIG operates with independence from the Secretary's office, and no public evidence of Becerra personally intervening in Prime's CIA was identified. The structural pattern is that the regulated entity is now backing the former regulator's next office.

### Second-strongest finding: Cantu / DHR Health and Stark Law

The Cantu Cal-Access designation as "Developer" omits the operative HHS-policy fact: Cantu is co-founder and Board of Managers member at **DHR Health** (Doctors Hospital at Renaissance, Edinburg TX), one of the largest physician-owned hospital systems in the US.

- **ACA §6001 (2010)** amended the Stark Law to ban *new* physician-owned hospitals from billing Medicare and prohibit grandfathered hospitals from expanding without CMS approval. DHR (founded 1997/1999, grandfathered) was directly affected.
- **United States ex rel. v. Doctors Hospital at Renaissance et al., 4:11-cv-02565 (S.D. Texas, 2011–2022).** Federal qui tam alleged Cantu used below-market Lone Star Bank loans to physicians as leverage to force patient referrals to DHR, in violation of Anti-Kickback Statute and Stark Law. February 2022: court **dismissed FCA claims against Cantu and the Bank with prejudice**, finding allegations were based on publicly disclosed information and relators were not the original source. **Cantu was not found liable.** ([federal court opinion via GovInfo](https://www.govinfo.gov/content/pkg/USCOURTS-txsd-4_11-cv-02565/pdf/USCOURTS-txsd-4_11-cv-02565-0.pdf))
- **DHR Brownsville expansion fight (2022).** Federation of American Hospitals and American Hospital Association jointly opposed DHR's CMS request to add a Cameron County campus, arguing it violated ACA §6001's spirit.
- **Cantu's Democratic donor history.** Bundled $600,000+ for Hillary Clinton 2008 from Rio Grande Valley physicians; explicitly motivated, per his own characterization, as "protection money" against legislation restricting physician-owned hospitals.

**Same-day Cantu-family donation cluster on 6/12/2025, verified in Cal-Access:**

| Donor | City | Filing role | Amount |
|-------|------|-------------|-------:|
| Alonzo Cantu | McAllen TX | Developer | $39,200 |
| Carlos Garcia-Cantu, MD FACS | McAllen TX | Self Employed Physician; confirmed general surgeon at DHR Health | $1,000 |
| Leonel Cantu, MD | McAllen TX | Self Employed Physician; DHR-affiliated internist | $5,000 |
| Melissa Cantu-Garza, PA | Pharr TX | Self Employed Physician Assistant; [UNVERIFIED beyond Cal-Access filing] | $2,100 |
| **Total same-day cluster** | | | **$47,300** |

Three of four are DHR-affiliated. The pattern mirrors Cantu's documented 2008 Hillary Clinton fundraising model. Family relationships among the four are inferred from surname patterns; no direct genealogical confirmation in this verification round.

### AltaMed: direct HHS funding pipeline

AltaMed is the largest FQHC in California (276,000+ predominantly Latino patients across LA and Orange Counties; 2024 total revenue $1.72 billion). Its funding runs straight through HHS:

| Year | Program | Amount |
|------|---------|-------:|
| FY 2022 | Teaching Health Center GME (THCGME) | $1,920,000 (2-yr) |
| FY 2023 | Nursing Workforce Diversity (HRSA BHW) | $649,736 |
| FY 2024–25 | Health Center Program (CFDA 93.224) | $500,000 |
| FY 2023–26 | HRSA award NH25PS005212 | $936,000 (multi-year) |
| FY 2026 | HRSA action 12/23/2025 | $4,487,637 |

FQHCs receive Section 330 Health Center Program grants from HRSA (an HHS sub-agency directly under the Secretary), mandatory cost-based Medi-Cal reimbursement, enhanced Medicare reimbursements, and 340B drug discounts, **all under HHS administration during Becerra's tenure**. The $39,200 max contribution arrives roughly six months after Becerra leaves HHS.

### Hedge-giving signature: McNicholas firm

The McNicholas firm and its principals gave **$944,124.40 total across California Democratic recipients in the 2025–26 cycle**, with identical $25,000 contributions to Becerra (6/11/2025) and Porter (6/24/2025) within two weeks. This is textbook hedge-giving by a major plaintiffs' firm with state regulatory and legislative interests; the operative interest is gubernatorial appointment access (bench, Insurance Commissioner, Public Utilities Commission).

### Inferences carried into this dossier (flagged per project standards)

1. **Raul Ayala / Kelly Ayala marital relationship:** strongly inferred from shared surname, city (Fresno), and identical contribution date 6/17/2025. No county marriage record located. **[Inferred]**
2. **Cantu family-cluster genealogy** (Carlos Garcia-Cantu, Leonel Cantu, Melissa Cantu-Garza ↔ Alonzo Cantu): surname pattern and DHR affiliation indicate family / extended-family network. No direct genealogical confirmation. **[Inferred]**
3. **Melissa Cantu-Garza, PA identity:** no Healthgrades or Doximity profile located; identity rests on Cal-Access filing alone. **[UNVERIFIED beyond Cal-Access]**
4. **Redwing Films Ltd CA SOS bizfile registration:** not directly confirmed via bizfile in this verification round, though employer is consistently listed across decades of campaign filings (FEC 2007, FPPC 2025). **[Tier 2]**
5. **Morgan Chu IRA / Medicare-negotiation opposition work:** not identified in public records; his life-sciences IP work has been for innovator biotech and academic clients, not against generic competition or CMS price-negotiation authority. **[UNVERIFIED]**

### Editorial framing (Phase 5g, supersedes prior framing on the same subjects)

Becerra's 2026 donor base is institutional-Democratic, but the verified detail layer sharpens what "institutional" means in his case: regulated entities that knew him in office now back him for higher office. The receipts that carry that frame are, in order of strength:

1. **Prime Healthcare $20K, 9/26/2025.** Active HHS-OIG Corporate Integrity Agreement throughout Becerra's HHS tenure. CIA estimated completion June 2026, concurrent with the gubernatorial cycle.
2. **Cantu family cluster $47,300 same-day, 6/12/2025.** DHR Health co-founder plus three DHR-affiliated physicians. DHR's expansion future depends on CMS Stark Law / ACA §6001 implementation, which Becerra's HHS administered.
3. **AltaMed $39,200, 7/1/2025.** Largest FQHC in California; HRSA grants directly under HHS during his tenure.
4. **Schaeffer $39,200, 4/15/2025** (from Phase 5b). WellPoint/Anthem founder; the cleanest single-frame receipt of insurance-industry money flowing to the former HHS Secretary.
5. **Raul Ayala $33,900 + Kelly Ayala $16,100 same-day, 6/17/2025.** Senior Adventist Health physician executive plus likely-spouse Kaiser Permanente OB/GYN. Combined $50,000 household contribution from rural FQHC and managed-care frontlines.

The frame the data supports: **the regulator who joined his regulators, in receipt form**. Each of these contributions can be read as an isolated event. Read together, they are a pattern of regulated healthcare entities funding the next office of the regulator who oversaw them.
...
- **Cal-Access bulk:** Tier 1, FPPC-disclosed primary source. CYCLE 2026 data present.
