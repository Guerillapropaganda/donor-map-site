---
title: "2026-03-22 Policy Research"
type: daily-update
...
### Daily Policy Research Log — March 22, 2026
...
### 1. SAVE America Act — Senate Cloture Vote

The Senate advanced two votes on March 22: a cloture motion on the nomination of **Markwayne Mullin (R-OK)** to be Secretary of Homeland Security passed **54-37**, and the Senate continued floor consideration of the **SAVE America Act** (H.R. 7296).
...
### 2. Iran War — $200B Pentagon Supplemental, Congressional Cracks

The Pentagon's $200B supplemental war funding request is fracturing GOP unity. Time reported bipartisan lawmakers voicing concern on March 20. Notably, Rep. Lauren Boebert (R-CO), a staunch Trump ally, said she would not support additional Iran war funding under any circumstance. The war has already cost ~$12B per National Economic Council Director Kevin Hassett.

Hegseth confirmed March 19 that the $200B figure "could move" — i.e., the actual ask may be higher. The US has struck more than 7,000 targets across Iran. The Strait of Hormuz remains closed — normally handling ~20% of global oil — and A-10 Warthogs are currently conducting strikes on Iranian fast-attack watercraft.

> [!money] Defense contractor windfall in real time
...
### 3. EPA — Greenhouse Gas Endangerment Finding Rescinded (Finalized Feb 2026)

The EPA finalized its rescission of the 2009 Greenhouse Gas Endangerment Finding on **February 12, 2026**, eliminating the legal prerequisite for regulating GHG emissions from motor vehicles. All subsequent GHG emission standards for light-, medium-, and heavy-duty vehicles were simultaneously repealed. EPA is targeting **31+ additional rules** for rollback in 2026, including Biden-era light/medium duty vehicle emission rules and the Clean Trucks Plan (NOx cuts from heavy-duty engines).
...
### 4. Housing Executive Order — Wetlands, Stormwater, Energy Standards

On **March 13, 2026**, Trump signed an EO titled *"Removing Regulatory Barriers to Affordable Home Construction"* directing:
- EPA and Army Corps to revise stormwater, wetlands, and water permitting to reduce construction costs
- HUD, Commerce, Transportation, FHFA to eliminate rules constraining residential development
- Agriculture, HUD, Energy, FHFA to eliminate energy, water, and alternative-energy requirements for housing, including manufactured homes

The order notably sets no deadlines and requires no White House reporting from agencies — giving agencies maximum flexibility and minimum accountability. Published in the Federal Register March 18.

> [!money] Who benefits from wetlands rollback
...
### 5. DOL/NLRB — Independent Contractor and Joint Employer Rollback

On **February 26, 2026**, the Department of Labor and NLRB jointly announced proposed rules to rescind Biden-era independent contractor and joint employer standards:
- **DOL**: Reinstating the Trump-era "economic reality" test (more permissive classification of workers as contractors)
- **NLRB**: Returning to the 2020 joint employer standard (actual exercise of control required, not reserved right to control)

Union election volume fell **30%** in 2025 (from 2,124 to 1,498 elections) — returning to first-Trump-term levels. Trump nominated management-side labor attorney **Crystal Carey** as NLRB General Counsel.
...
### 6. AI National Policy Framework — Federal Preemption of State Laws

On **March 20, 2026**, the White House released a legislative blueprint for a national AI policy framework pursuant to Trump's December 11, 2025 EO. The blueprint:
- Urges Congress to adopt federal AI standards with preemption of state AI laws
- Directs Commerce Department to identify burdensome state laws (deadline was March 11)
- Directs FTC to classify state-mandated bias mitigation as a per se deceptive trade practice
- Carve-outs: child safety, AI compute infrastructure, state government procurement
...
### 7. SCOTUS — Key March 2026 Opinions

**Learning Resources, Inc. v. Trump** (Feb 20, 2026): 6-3 ruling that IEEPA does not authorize presidential tariff imposition. Chief Justice Roberts wrote for the majority. This limits Trump's unilateral tariff authority, though the administration has indicated it will pursue other legal bases.

**Mirabelli v. Bonta** (March 2, 2026): Court held California likely cannot enforce its school notification rule — requiring that schools use children's preferred names/pronouns and notify parents about gender identity — without parental consent. Preliminary injunction likely stands.
...
### 8. ICE — Surveillance Infrastructure Expansion

As of March 20, 2026, ICE has signed **1,547 Memorandums of Agreement for 287(g) programs** covering 39 states and 2 territories — deputizing local law enforcement as immigration agents. ICE is also using the **ELITE app**, which draws on Medicaid records to obtain home addresses of targets.
...
### 9. California — Single-Payer Returns as Governor Race Flashpoint

CalMatters reported this week that single-payer healthcare has re-emerged as a central issue in the 2026 California governor's race. [[_Katie Porter Master Profile|Katie Porter]] endorsed single-payer in a video to party delegates ("as governor, I will deliver single-payer health care"). The issue is resurfacing after California cut Medi-Cal coverage for undocumented immigrants in the budget crunch, with one legislator now seeking to restore it (Times of San Diego, March 11).
...
The following developments are significant enough to warrant dedicated vault sub-notes:

1. **`DOL-NLRB Contractor Rollback 2026.md`** — The February 26 joint announcement rescinding Biden independent contractor/joint employer standards. Connect to [[Uber]], [[Lyft]], [[DoorDash]], Gig Economy donor node, and labor unions.

2. **`EPA Endangerment Finding Rescission 2026.md`** — The February 12 finalization of GHG Endangerment Finding rescission. This is a landmark regulatory event — the legal foundation for all EPA climate regulation gone. Connect to [[ExxonMobil]], [[Chevron]], [[American Petroleum Institute]], [[Fossil Fuel Bloc]], [[Kelcy Warren]].

3. **`AI National Policy Framework 2026.md`** — The March 20 White House AI blueprint and preemption push. Connect to MAGA Inc mega-donors (Brockman, Crypto.com), tech deregulation agenda, California AI regulation implications for governor race.

4. **`ICE 287(g) Expansion and ELITE Surveillance.md`** — The 1,547 MOA expansion and Medicaid data use for deportation targeting. Connect to Carceral State donor network, private prison industry, and Medicaid funding politics.

5. **`Iran War Supplemental — $200B Request.md`** — Pentagon's request and congressional fractures. Connect to [[Lockheed Martin]], [[Boeing]], Armed Services/Appropriations donor cross-reference.
...
| Note | Update Needed |
|------|--------------|
| [[Lockheed Martin]] | Add Iran war supplemental funding context; 7,000+ strikes = contract volume |
| [[Boeing]] | Same as Lockheed — supplemental spending context |
| [[ExxonMobil]] | Add Endangerment Finding rescission as policy return; Hormuz oil price dynamics |
| [[American Petroleum Institute]] | Endangerment Finding rescission is their 40-year lobbying prize |
| [[Fossil Fuel Bloc]] | Add Endangerment Finding rescission and housing EO wetlands rollback |
| [[UnitedHealth Group - Optum]] | Add CA single-payer emergence as existential threat; ICE/Medicaid data intersection |
| [[_Pete Hegseth Master Profile]] | Update with $200B supplemental context, confirmed no war end-date, press crackdown ruling |
