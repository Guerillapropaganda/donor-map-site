---
title: "2026-03-23 Policy Research"
type: daily-update
...
### Daily Policy Research Log. March 23, 2026
...
### 1. Iran War Day 24. Trump's Hormuz Ultimatum Expires Tonight, Markets Reel

The most consequential policy event of the day: Trump's 48-hour ultimatum for Iran to reopen the Strait of Hormuz expires at approximately 23:44 GMT Monday (3:14am Tuesday Iran time). Iran's military declared it is ready to close the strait indefinitely and attack regional infrastructure if Trump carries out his threat to bomb power plants.

**Oil market impact:** Brent crude at ~$113.52/bbl (+1.18%), WTI at ~$99.88/bbl (+1.68%). Brent peaked at $126/bbl earlier in the crisis and has surged over 60% in the past month. Asian stock indexes fell more than 5% Monday morning. Japan's Nikkei and South Korea's Kospi leading declines. The IEA described this as the largest supply disruption in the history of the global oil market.
...
### 2. SEC Crypto Safe Harbor. Atkins Delivers for Fairshake/a16z Donor Bloc

On March 17, SEC Chair Paul Atkins announced "Regulation Crypto Assets", a sweeping safe harbor framework for the crypto industry. This is the single largest regulatory win the crypto donor bloc has purchased:

**Token taxonomy:** 16 crypto assets (including Bitcoin, Ethereum, Solana) officially classified as "digital commodities", not securities, under a joint SEC/CFTC interpretive release. This removes them from SEC enforcement jurisdiction entirely.

**Safe harbor for startups:** A time-limited exemption (up to 4 years) allowing early-stage crypto projects to raise up to ~$5M with minimal disclosure. This is exactly what [[Fairshake PAC|Fairshake]] and [[a16z - Andreessen Horowitz|a16z]] lobbied for.

**Five-category classification:** Digital commodities, digital collectibles, digital tools, stablecoins, and digital securities. Only the last category remains under full SEC regulation.

> [!money] The Fairshake return on investment
...
### 3. ICE Detention Expansion, $45B, 72,000+ Detained, 220+ Facilities

NPR reported March 23 on the continued explosive growth of ICE's detention infrastructure:

**Scale:** Over 72,000 people held in immigration detention by end of January 2026, across 220+ sites nationwide. Texas alone logged 200,000+ book-ins across 115 facilities between January 2025 and mid-October 2025.

**Funding:** The administration is working with $45 billion specifically allocated to expand immigration detention over four years, from the first reconciliation bill's Medicaid/social spending cuts redirected to enforcement.

**Community resistance:** ICE is leasing and retrofitting warehouses and buildings across the country, with elected officials at all levels complaining about lack of transparency. This is creating local political fights even in conservative areas.

> [!money] Private prison donor windfall
> The detention expansion is a direct revenue pipeline for vault-tracked private prison operators [[CoreCivic]] and [[GEO Group]], plus prison telecom companies [[Securus Technologies - Aventiv]] and [[ViaPath Technologies - GTL]]. Food service contractor [[Aramark]] also benefits from per-detainee contracts. Cross-reference with carceral state donor profiles. The $45B in detention funding represents the largest single transfer of public money to private prison contractors in US history.
...
### 4. Reconciliation 1.0 Medicaid Fallout. Implementation Timeline Approaching

The "One Big Beautiful Bill Act" (H.R.1), signed July 4, 2025, is entering its implementation phase with deadlines approaching:

**October 1, 2026:** Medicaid eligibility narrowed for certain non-US citizens
**December 31, 2026:** States required to conduct eligibility redeterminations every six months (doubled frequency)
**January 2027:** First-ever national Medicaid work requirements (80 hours/month) take effect, the single largest component of cuts ($325.8B over ten years)
...
### 5. DOGE Contradiction Deepens. Spending Up, Workforce Down, Deficit Unchanged

Multiple reports confirm what the vault has tracked: DOGE has failed at its stated mission while succeeding at its unstated one.

**Federal workforce:** Down ~9% (3.015M → 2.744M workers), the largest peacetime workforce reduction on record.

**Federal spending:** Up, not down. A DOGE staffer confirmed under deposition that the agency was unable to lower the federal deficit. CBS News analysis: DOGE's claimed $160B in savings have been offset by $135B in costs from the cuts themselves (severance, contract terminations, legal challenges, operational disruptions).

**National security cost:** CNN documented how DOGE cuts hampered emergency preparedness, terror threat monitoring, cyber-attack defense, Iran broadcasting, and citizen assistance abroad, all during an active war.
...
### 6. SCOTUS. Olivier v. City of Brandon (Free Speech), Immigration Deference

Two notable SCOTUS developments since last scan:

**Olivier v. City of Brandon (March 20):** Case involving a street preacher convicted under a Mississippi city ordinance restricting expressive activities near a public amphitheater. First Amendment implications for public space regulation. Decision details pending full review.

**Urias-Orellana v. Bondi (March 4, unanimous):** Justice Jackson authored a ruling requiring federal appeals courts to defer to immigration judges when reviewing asylum decisions, bolstering executive branch authority. This is a significant win for the Trump administration's deportation agenda, handed to them by a unanimous court including liberal justices.
...
### 7. NLRB. Fair Choice Rule Published, But Agency Capacity Gutted

The NLRB published its Fair Choice–Employee Voice Final Rule, restoring three pro-worker policies: blocking charge policy, voluntary union recognition bar (restoring 56-year precedent), and construction industry bargaining parity. Effective September 30, 2026.
...
### 8. Executive Orders. Fraud Task Force, Army-Navy Game

Two recent executive orders not previously covered:

**Task Force to Eliminate Fraud (March 16):** VP chairs a task force to combat fraud in federal benefit programs. FTC Chairman serves as Vice Chair. Given reconciliation's Medicaid work requirements and eligibility redeterminations, this positions the administration to frame coverage losses as "fraud elimination" rather than policy-driven disenrollment.
...
### Vault Cross-References and Flags

### Notes to update:
- [[Lockheed Martin]]. Add reconciliation 2.0 $450B defense push, Iran supplemental $200B
- [[Miriam Adelson]]. Hormuz ultimatum as direct policy return
- [[Fairshake PAC|Fairshake]] / [[a16z - Andreessen Horowitz|a16z]]. SEC safe harbor framework as policy win
- [[CoreCivic]] / [[GEO Group]], $45B detention expansion, 72K+ detained
- [[ExxonMobil]] / [[Chevron]]. Oil at $113/bbl windfall from Hormuz closure
- [[Stand Together]]. DOGE spending-up-workforce-down pattern as Koch agenda

### New sub-notes flagged:
- SEC Crypto Safe Harbor. The Fairshake Policy Return (connects to Contradiction 06 and 09)
- Reconciliation 2.0. The Defense Spending Vehicle (connects Iran war to domestic policy)
- ICE Detention Infrastructure Boom. The $45B Private Prison Pipeline
- DOGE Deposition Revelations. The Federal Capacity Destruction Model
- Medicaid Implementation Timeline. October 2026 Eligibility Cliff
