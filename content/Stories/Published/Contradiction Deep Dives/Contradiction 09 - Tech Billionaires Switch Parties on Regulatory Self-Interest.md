...
- [OpenSecrets: Elon Musk donor lookup](https://www.opensecrets.org/donor-lookup/results?name=elon+musk&order=desc&sort=D) (Tier 1)
...
- [OpenSecrets: Reid Hoffman donor lookup](https://www.opensecrets.org/donor-lookup/results?name=Reid+Hoffman&order=desc&sort=D) (Tier 1)
