...
| **Deirdre Stach** | Government background (revolving door flagged) | American Public Education, Gallaudet University, Society for Human Resource Management, Syracuse University | Education sector revolving door |
| **Avery Royster** | Government background (revolving door flagged) | Stand with Parkland | Revolving door profile on OpenSecrets |

> [!contradiction]
> Mercury fielded two people who became central to Trump's second administration — from inside the same lobbying shop. Susie Wiles co-chaired Trump's 2024 campaign while serving as Mercury's Co-Chair, representing foreign governments and corporate clients. Bryan Lanza, Mercury's Chinese tech specialist, ran Trump 2016 campaign communications and transition. Mercury simultaneously lobbied for the Embassy of India ($325K, fighting Trump's 50% tariff), Chinese companies under Trump trade scrutiny (Alibaba, Tencent, TP-Link, Gotion), a sanctioned Russian oil company (Lukoil, via Lanza personal consulting), Ukraine advocacy (Stand With Ukraine, $500K), and the government of Qatar ($300K). Every one of these clients either benefits directly from or seeks protection against policies shaped by the Trump administration whose most powerful personnel Mercury helped install. The firm is not choosing sides. It is charging all sides simultaneously.

> [!contradiction]
> Bryan Lanza ran communications for the Trump campaign and transition — the same campaign that ran on confronting China's trade practices, banning ZTE, and protecting American tech from Chinese influence. Within days of leaving the White House transition team, Lanza was at Mercury representing ZTE, the Chinese telecom Trump's Commerce Department had placed on export restriction. Trump expressed sympathy for ZTE; a deal was announced two weeks after ZTE hired Lanza. The contradiction is not incidental — it is the service being sold. Trump allies who represent Chinese firms are not violating Trump's China policy. They are monetizing the gap between Trump's rhetoric and the access he grants to loyalists' clients.
...
|------|-----------------|--------|---------------|----------|
| 2012 | U.S. Congress (via Manafort/ECMU) | $1.02M | Pro-Yanukovych congressional sentiment; Tymoshenko imprisonment not challenged | Concurrent |
| 2018 | ZTE/Commerce Department | $75K/month | ZTE entity list suspension; operating deal announced within weeks | ~2 weeks |
| 2020 | Alibaba/Treasury | Active client | Sanctions not applied during Trump 1.0; continued operations in US | Concurrent |
| 2025 | Tencent/Congress (NDAA) | Active client | NDAA provisions targeting Chinese tech still in negotiation | Ongoing |
| 2025 | Gotion/Commerce/DOD | Active client | Federal national security review ongoing; state-level bans pursued | Ongoing |
| 2025 | Stand With Ukraine/Congress | $500,305 | Ukraine aid appropriations advocacy amid Trump drawdown pressure | Concurrent |
| 2025 | Government of Qatar/State | $300,000 | Qatar diplomatic relationship maintenance | Concurrent |
| 2025 | Venture Global LNG/FERC/DOE | Active client | LNG export terminal approvals under Trump energy expansion | Concurrent |
| Dec 2025 | Lukoil International/Treasury | Consulting fee (undisclosed) | Treasury extended Lukoil divestiture deadline from Dec 13 to Jan 17, 2026 | ~2 weeks |
| 2025 | Elanco Animal Health/Congress | $140,000 (Q4) | Top Q4 billing; agricultural pharma regulatory | Concurrent |

> [!money]
> The pattern repeats across every sanctioned or scrutinized entity that hires Mercury: ZTE (2018, entity list → deal in 2 weeks), Alibaba (sanctions defense), Tencent (NDAA provisions), Gotion (national security review), Xiaomi (military designation → reversal), TP-Link (active investigation), and now Lukoil (sanctioned Russian oil → Treasury deadline extension in weeks). The fee is not for policy expertise — Mercury employs a former OFAC sanctions architect (Kucik) and a Trump campaign insider (Lanza) — the combination of regulatory knowledge and political access is the product.
...
- [Senate LDA Filings: Mercury Lobbying Profile](https://lda.senate.gov/filings/public/filing/search/) (Tier 1)
- [Senate LDA Filings: Mercury Lobbyists 2025](https://lda.senate.gov/filings/public/filing/search/) (Tier 1)
