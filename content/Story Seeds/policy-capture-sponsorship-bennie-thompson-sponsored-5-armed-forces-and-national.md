...
```bash
node -e "require('./scripts/lib/false-positive-log.cjs').recordRejection('contradiction-miner', 'policy-capture-sponsorship-bennie-thompson-sponsored-5-armed-forces-and-national', 'story seed policy-capture-sponsorship', 'REASON_HERE')"
```