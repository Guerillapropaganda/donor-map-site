...
```bash
node -e "require('./scripts/lib/false-positive-log.cjs').recordRejection('contradiction-miner', 'policy-capture-sponsorship-andre-carson-sponsored-8-armed-forces-and-national-se', 'story seed policy-capture-sponsorship', 'REASON_HERE')"
```