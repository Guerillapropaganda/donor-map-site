...
const BEATS_NEW: BeatRecord[] = [
  ...
  },
  {
    ...
    verificationSeeds: [
      ...
      {
        id: "second-floor-suite-tenants",
        beat: "second-floor",
        label: "FLAG: verify full tenant directory of 3649 Mission Inn Ave Fl 2",
        detail: "Gemini-sourced and unflagged in published copy with red 'verify' chip. Tenants per Gemini: Troast & Associates LLC, Standard Riverside LLC, Law Office of Matt Hill Esq, Riverside Sheriffs' Association lobbying (Ryan Sherman + Joe Cameron). Confirm via building directory, phone call, or business filings before public-routes flip.",
        lane: "Editor",
      },
      {
        id: "second-floor-mitchell-treasurer",
        beat: "second-floor",
        label: "FLAG: verify Jennifer Mitchell as treasurer of 3 candidate committees",
        detail: "Gemini-sourced claim that Jennifer Mitchell is treasurer of record for Perez Sup 2026 (#1396909), Gutierrez Sup 2026 (#1439760), and DeJohnette Council 2024 (#1473823). Confirm via each Form 460 cover page.",
        lane: "Editor",
      },
      {
        id: "second-floor-sanmanuel-perez-donor",
        beat: "second-floor",
        label: "FLAG: verify San Manuel Band as V. Manuel Perez top contributor",
        detail: "Gemini-reported claim, load-bearing for the final pull-quote ('buyers of the hotel are donors to the supervisor whose campaign is filed from the hotel they are buying'). Earlier session research surfaced Riverside Sheriffs Association Education Fund + LIUNA Local 777 PAC as the top reported donors. Resolve the discrepancy before publication. If San Manuel is NOT a top Perez donor, the final pull-quote must be rewritten.",
        lane: "Editor",
      },
    ],
    perplexityRounds: [
