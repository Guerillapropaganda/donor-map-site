...
const BEATS_UPCOMING: BeatRecord[] = [
  {
    slug: "mahan",
    publicSlug: "mahan",
    title: "Mahan: $0 from voters, $5.49M from Silicon Valley billionaires",
    deck:
      "Matt Mahan's direct candidate committee shows zero 2026-cycle voter contributions. The supporting IE PAC is funded by Moritz ($2M) + Hastings ($1M) + Seibel ($1M) + Collison ($990K) + Larsen ($500K). The donor base is the campaign.",
    ...
    perplexityRounds: [
      ...
      { name: "Mahan donor verification + IE structure (deeper round)", status: "queued (Prompt #3)", date: "queued" },
    ],
    auditPasses: [],
    editorialChecklist: [
      { label: "Target ship date", detail: "May 13, 2026 (Wed)", status: "pending" },
      { label: "Cal-Access RCPT_CD primary verification", detail: "Five-donor IE bloc $5.49M verified for IE PAC FPPC #1487425", status: "done" },
      { label: "San Jose mayoralty record specifics", detail: "Pending dedicated Perplexity round (Prompt #3)", status: "pending" },
      { label: "Prototype HTML", detail: "beat-mahan.html · 948 lines", status: "done" },
    ],
  },
  {
    slug: "cop-coddler",
  ...
  },
  {
    ...
    editorialChecklist: [
      ...
      { label: "Per-candidate Perplexity parity", detail: "Prompts 5+8 still open; 6+7 applied", status: "pending" },
      { label: "Prototype HTML", detail: "Not yet built", status: "pending" },
    ],
  },
  {
    ...
    deck:
      "Riverside County Sheriff seized 650,000 ballots from the 2025 Prop 50 referendum on a warrant from a judge he had endorsed. Plus 2014 Oath Keepers membership confirmed by LAist + NPR. Plus $156,800 from sibling-managed donor entities. Plus the constitutional-sheriffs network.",
    prototypeFile: "(not yet built)",
    prototypeUrl: "",
    ...
    auditPasses: [],
    editorialChecklist: [
      { label: "Target ship date", detail: "Race Map June 1 OR standalone post-primary if Bianco performance warrants", status: "pending" },
      { label: "Source material exists", detail: "C-005 in emerging-beat-candidates.md; Cal-Access RCPT_CD verified for committee 1479095", status: "done" },
      { label: "Prototype HTML", detail: "Not yet built", status: "pending" },
    ],
  },
  {
    ...
    title: "Villaraigosa: The Pledge He Broke",
    deck:
      "Signed a 2018 pledge not to take fossil-fuel money. In 2026 he is the principal Democrat beneficiary of oil-and-gas donations: $307K combined from CRC, Chevron, Marathon, Berry. Opposes single-payer while taking healthcare-industry money. Mercury Public Affairs clients included Hungary, Qatar, Turkey. Reed Hastings dropped him for Mahan.",
    prototypeFile: "(not yet built)",
    prototypeUrl: "",
    ...
    auditPasses: [],
    editorialChecklist: [
      { label: "Target ship date", detail: "Race Map June 1 thread OR standalone if runoff scenario", status: "pending" },
      { label: "Source material exists", detail: "C-006 in emerging-beat-candidates.md; Cal-Access RCPT_CD verified for committee 1471635", status: "done" },
      { label: "Prototype HTML", detail: "Not yet built", status: "pending" },
    ],
  },
]
