...
const CARDS = [
  ...
  {
    slug: 'hilton',
    out: path.join(SHARE_DIR, 'hilton.png'),
    headline: 'He wants to regulate AI. He owns stock in an AI company.',
    deck: "Steve Hilton's own sworn Form 700. Personal equity in Sierra Technologies. Spouse paid by Sierra Technologies.",
    accent: '#e63946',
    headlineSize: 60,
    headlineFont: 'Inter-Black',
  },
  ...
  },
  {
    ...
    deck: 'Every disclosed holding. Sierra Technologies. SPDR Gold. Five oil majors. Thirteen pharma equities. Defense and aerospace.',
    accent: '#fbbf24',
    headlineSize: 64,
    headlineFont: 'Inter-Black',
  },
  ...
  {
    slug: 'spencer-pratt',
    out: path.join(SHARE_DIR, 'spencer-pratt.png'),
    headline: 'What $540,000 to Spencer Pratt looks like.',
    deck: 'Six Form 497 late-contribution reports in a single week. The CEO of the New York Stock Exchange. The GUESS Jeans founding family. The Ring founder. The Tinder founder. Two corporations LA bans from giving.',
    accent: '#e63946',
    headlineSize: 56,
    headlineFont: 'Inter-Black',
  },
  {
    slug: 'spencer-pratt-receipts',
    out: path.join(SHARE_DIR, 'spencer-pratt-receipts.png'),
    headline: 'Pratt for Mayor 2026 · full receipts.',
    deck: 'Every Schedule A and Schedule E donor table from the Pratt investigation, in full. Top-25 named donors, out-of-state, top-20 payees, the celebrity tier, and the six Form 497 late-contribution filings row by row.',
    accent: '#fbbf24',
    headlineSize: 60,
    headlineFont: 'Inter-Black',
  },
  {
    slug: 'spencer-pratt-deep-dives',
    out: path.join(SHARE_DIR, 'spencer-pratt-deep-dives.png'),
    headline: 'Pratt for Mayor 2026 · donor deep-dives.',
    deck: 'Full dossiers on the four most structurally telling Pratt donors: Haim and Cheryl Saban, the Grainge family, Jeffrey Sprecher and Kelly Loeffler, and the Marciano family.',
    accent: '#1d4ed8',
    headlineSize: 60,
    headlineFont: 'Inter-Black',
  },
