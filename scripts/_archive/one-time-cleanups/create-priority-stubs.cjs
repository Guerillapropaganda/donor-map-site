...
const STUBS = [
  ...
  // Third batch 2026-04-18
  { title: 'North Fund', ein: '834011547', sector: 'Dark Money', status: '501(c)(4)', kind: '501(c)(4)', folder: 'Dark Money', note: 'Arabella Advisors-managed 501(c)(4) pass-through fiscal sponsor. Paired with Hopewell Fund on the c3 side. Part of the Arabella dark-money infrastructure stack.' },
  { title: 'Proteus Fund', ein: '043243004', sector: 'Dark Money', status: '501(c)(3)', kind: '501(c)(3)', folder: 'Dark Money', note: 'Progressive-aligned pooled donor fund; hosts collaborative funds including Funders for LGBTQ Issues, RISE Together Fund, Piper Fund.' },
  { title: 'States Newsroom', ein: '842113822', sector: 'Media & Influence', status: '501(c)(3)', kind: '501(c)(3)', folder: 'Media & Influence', note: 'Progressive-aligned state-level nonprofit news network operating newsrooms in 30+ state capitals. Funded by Arabella network and other progressive philanthropy.' },
  { title: 'NEO Philanthropy', ein: '133191113', sector: 'Dark Money', status: '501(c)(3)', kind: 'Fiscal Sponsor', folder: 'Dark Money', note: 'Fiscal-sponsor network hosting dozens of social-justice project entities. Major progressive fiscal sponsor alternative to Tides.' },
  { title: 'Sierra Club Foundation', ein: '946069890', sector: 'Dark Money', status: '501(c)(3)', kind: '501(c)(3)', folder: 'Dark Money', note: 'Sierra Club 501(c)(3) foundation; distinct corporate entity from Sierra Club 501(c)(4) advocacy org.' },
  { title: 'Natural Resources Defense Council', ein: '132654926', sector: 'Dark Money', status: '501(c)(3)', kind: '501(c)(3)', folder: 'Dark Money', note: 'Major environmental advocacy 501(c)(3). Paired with NRDC Action Fund (c4) for lobbying.' },
  { title: 'Equal Justice Initiative', ein: '631135091', sector: 'Dark Money', status: '501(c)(3)', kind: '501(c)(3)', folder: 'Dark Money', note: 'Bryan Stevenson-led death penalty and prison reform advocacy org. Major recipient from liberal foundations and individual donors.' },
  { title: 'Center for Popular Democracy', ein: '453813436', sector: 'Dark Money', status: '501(c)(3)', kind: '501(c)(3)', folder: 'Dark Money', note: 'Progressive advocacy network coordinating state-level organizing groups. Paired with CPD Action (c4). Dual EINs 453813436 (c3) and 453813416 (c4) observed in grant records.' },
];
