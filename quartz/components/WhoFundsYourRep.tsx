  ...
  function showState(stateName) {
    ...
    for (var c = 0; c < chambers.length; c++) {
      ...
      for (var i = 0; i < chamberReps.length; i++) {
        ...
        var statusClass = (r.readiness === 'ready' || r.readiness === 'publication-ready') ? 'wf-verified' : 'wf-draft';
        var statusText = (r.readiness === 'ready' || r.readiness === 'publication-ready') ? 'VERIFIED' : 'DRAFT';
